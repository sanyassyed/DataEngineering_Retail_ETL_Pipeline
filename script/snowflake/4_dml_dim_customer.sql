...
-- dim_customer
-------------------------------------------------------------
-- Populates customer dimension based on project requirements.

SELECT * FROM SF_TPCDS.INTERMEDIATE.dim_customer_intermediate;

MERGE INTO SF_TPCDS.INTERMEDIATE.dim_customer_intermediate t1
...
create or replace table SF_TPCDS.ANALYTICS.dim_customer as
        (select 
        C_SALUTATION,
        C_PREFERRED_CUST_FLAG,
        C_FIRST_SALES_DATE_SK,
        ...
        START_DATE,
        END_DATE
from SF_TPCDS.INTERMEDIATE.dim_customer_intermediate
...
SELECT * from SF_TPCDS.ANALYTICS.dim_customer where end_date is null;
