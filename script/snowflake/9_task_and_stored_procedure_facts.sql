-----------------------------------------------
-- tasks_and_stored_procedure_facts.sql
-----------------------------------------------

-- Showcase how queries can be run on Snowflake on a schedule using tasks and stored procedures.
